...
class FunkinLua
{
	...
	public function new(script:String)
	{
		...
		set('ratingName', '');
		set('ratingFC', '');
		set('version', MainMenuState.psycheVersion.trim());
		...
		set('buildTarget', 'mac');
		#elseif html5
		set('buildTarget', 'browser (invalid)'); // changing these to " (invalid)" probably breaks some scripts. oh well!
		#elseif android
		set('buildTarget', 'android (invalid)');
		#else
